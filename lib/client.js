...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /**
     * The day-scale window: sixteen weeks, always.
     *
     ...
     * contribution was to shrink every square. A quarter of a year is the whole
     * useful question here, and a fixed column count is also what lets the daily
     * grid and the weekly bars stay one shape at any width.
     */
